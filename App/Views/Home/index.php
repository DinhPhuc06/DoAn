...
<section class="hero">
    <div class="hero-slide active">
        <img src="<?= \App\Core\url('assets/image/presidential.jpg') ?>">
    ...
    <div class="hero-content">
        ...
        <a href="<?= \App\Core\url('rooms') ?>" class="btn hero-btn btn-white">Xem Phòng</a>
        <a href="<?= \App\Core\url('rooms/search') ?>" class="btn hero-btn btn-primary">Đặt Phòng Ngay</a>
        </div>
    </div>

    <!-- Search Box -->
    <div class="search-box">
        <form class="search-form" action="<?= \App\Core\url('rooms/search') ?>" method="GET">
    ...
    <div class="container">
        ...
        <div class="rooms-grid">
            ...
            foreach ($displayRooms as $rt):
                ?>
                <div class="room-card">
                    <a href="<?= \App\Core\url('room-types/' . $rt['id']) ?>" class="room-image" style="display: block;">
                        <img src="<?= \App\Core\url($rt['image_path'] ?? 'assets/image/image.png') ?>"
                    ...
                    <div class="room-content">
                        <a href="<?= \App\Core\url('room-types/' . $rt['id']) ?>" style="text-decoration: none; color: inherit;">
                        ...
                        <div style="margin-top: 15px;">
                            <a href="<?= \App\Core\url('rooms/search?room_type_id=' . $rt['id']) ?>" 
