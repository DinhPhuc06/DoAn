<div class="admin-card">
    <div class="admin-card-header">
        ...
        <a href="<?= \App\Core\url('/admin/room-types') ?>" class="admin-btn admin-btn-outline">
            <i class="fa-solid fa-arrow-left"></i> Quay lại
        </a>
    </div>
    <div class="admin-card-body">
        <form action="<?= \App\Core\url($roomType ? '/admin/room-types/' . $roomType['id'] . '/update' : '/admin/room-types/store') ?>"
